# -*- coding: utf-8 -*-
"""
Prompt Manager Dialog for Email Composer Pro Add-on
Allows users to manage custom prompts for email generation and text refinement
"""
...
class PromptManagerDialog(wx.Dialog):
    ...
    def _confirm_guarded_save(self, item):
        ...
        msg = _(
            ...
            "Do you understand the risk and want to save these modifications anyway?"
        ).format(feature=feature)
        # Translators: Title of confirmation dialog shown before saving guarded prompts.
        title = _("Confirm")
        
        # Fixed: Removed the incompatible SetYesNoLabels method invocation entirely
